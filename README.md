...
- A generated 1.6L V6 turbo engine bank (firing-rate correct, load-dependent, with turbo spool, blow-off, anti-lag and an MGU-K whine) plus synthesized tires, wind, impacts, limiter, and gear shifts. The audio is generated by `npm run build:audio`, not sampled from a recording.
